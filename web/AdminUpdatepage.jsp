    ...
    <body>
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-2 sidbar ">
          ...
          <ul class="navbar-nav flex-column mt-4">
            <li class="nav-item"> <a href="Adminview.jsp" class="nav-link text-white p-3 mb-2"><i class="fas fa-home text-white mx-2"></i>Home</a>
                <li class="nav-item"> <a href="Adminview.jsp" class="nav-link text-white p-3 mb-2"><i class="fas fa-table mx-2"></i>View Information</a>
                    <li class="nav-item"> <a href="AdminUpdatepage.jsp" class="nav-link text-white p-3 mb-2"><i class="fa fa-user-plus mx-2" aria-hidden="true"></i>Add Information</a>
                        <li class="nav-item active"> <a href="#" class="nav-link text-white p-3 mb-2"><i class="fas fa-sync-alt mx-2"></i>Update Information</a>
                          <li class="nav-item"> <a href="AdminDeletepage.jsp" class="nav-link text-white p-3 mb-2"><i class="fas fa-user-minus mx-2"></i>Delete Information</a>
                            <li class="nav-item"> <a href="Adminsuggestion.jsp" class="nav-link text-white p-3 mb-2"><i class="fas fa-envelope-open-text mx-2"></i>View Feedback</a>
       ...
       <form action="" method="get">
          ...
          <input class="btn btn-danger" type="submit" value="Search" name="q" id="q" />
            ...
            <div class="text-right">
             <a class="btn btn-danger" href="update.jsp" role="button">Add data</a>
             </div>
                   ...
                   data="select *from doctorinfo";
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                             ...
                             <a class="btn btn-primary" href='updateagain.jsp?u=<%=res.getString("id")%>' role="button">Edit</a>
